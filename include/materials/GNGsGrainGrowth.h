 ...
 */
class GNGsGrainGrowth : public Material
{
public:
  static InputParameters validParams();

  GNGsGrainGrowth(const InputParameters & parameters);
...
protected:
  ...
  virtual void computeGBParamaterByGrainSize();
  ...
  // const VectorPostprocessorName & _vector_postprocessor_name;
