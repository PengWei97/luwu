 ...
 */
class FeatureFloodCountGG : public GeneralPostprocessor,
                          public Coupleable,
...
public:
  ...
  FeatureFloodCountGG(const InputParameters & parameters);
...
protected:
   ...
   * across time steps. The FeatureFloodCountGGer however does not. This container is here so that
...
template <>
void dataStore(std::ostream & stream, FeatureFloodCountGG::FeatureData & feature, void * context);
template <>
void dataStore(std::ostream & stream, BoundingBox & bbox, void * context);

template <>
void dataLoad(std::istream & stream, FeatureFloodCountGG::FeatureData & feature, void * context);
template <>
void dataLoad(std::istream & stream, BoundingBox & bbox, void * context);

template <>
struct enable_bitmask_operators<FeatureFloodCountGG::Status>
{
  static const bool enable = true;
};

template <>
struct enable_bitmask_operators<FeatureFloodCountGG::BoundaryIntersection>
{
  static const bool enable = true;
};