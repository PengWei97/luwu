...
/**
 * ComputeElasticityTensorPW defines an elasticity tensor material object with a given base name.
 */
template <bool is_ad>
class ComputeElasticityTensorPWTempl : public ComputeRotatedElasticityTensorBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  ComputeElasticityTensorPWTempl(const InputParameters & parameters);
...
typedef ComputeElasticityTensorPWTempl<false> ComputeElasticityTensorPW;
typedef ComputeElasticityTensorPWTempl<true> ADComputeElasticityTensorPW;
