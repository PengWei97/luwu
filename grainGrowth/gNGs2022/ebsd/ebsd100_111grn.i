...
[Mesh]
  [ebsd_mesh]
    ...
    filename = 4_Ti700du_10minFill.inl # 50*50
    #4_Ti700du_10minFill.inl #Ti700du_10minFill_3.inl #Small_IN100_4.txt
    # pre_refine = 2
  []
[]
...
[Executioner]
  ...
  [Adaptivity]
    ...
    refine_fraction = 0.7 # The fraction of elements or error to refine.
    coarsen_fraction = 0.3 # The fraction of elements or error to coarsen.
    max_h_level = 3
  []
[]
